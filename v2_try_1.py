...
# with open(r'base grids/v2_base_grid.txt') as f: grid = eval(f.read())
tile_size = 32
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.unicode.isdigit():
                try: load_grid(fr'base grids/v{event.unicode}_base_grid.txt')
                except: ...
    
    if jkeys[pygame.K_RETURN] and editable:
        save_grid(r'base grids/v2_base_grid.txt')
